<template>
  <div class="section-heading">
    ...
    <div class="container">
      <p>Web developer with more than <strong>2 years</strong> of well-rounded experience with a master in the
        field of 
        <strong>Human factors and Ergonomics</strong>, extensive knowledge of modern Web techniques and love for <strong>Protein shake</strong>.
